package xronbo.ronbolobby.hpbar;
...
public class Util {
	...
	public static final Class<?> DRAGON_CLASS = v1_8_PROTOCOL_HACK.class;
	...
	public static FakeDragon newDragon(String message, Location loc) {
		...
		try {
			fakeDragon = (FakeDragon) DRAGON_CLASS.getConstructor(String.class, Location.class).newInstance(message, loc);
