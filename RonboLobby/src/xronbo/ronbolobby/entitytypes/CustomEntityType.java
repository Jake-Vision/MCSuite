...
public enum CustomEntityType {
    ...
    Enderman("Enderman", 58, EntityType.CREEPER, EntityEnderman.class, CustomEnderman.class),
    Squid("Squid", 94, EntityType.SQUID, EntitySquid.class, CustomSquid.class),
    SnowMan("SnowMan", 97, EntityType.SNOWMAN, EntitySnowman.class, CustomSnowman.class),
    Ozelot("Ozelot", 98, EntityType.OCELOT, EntityOcelot.class, CustomOcelot.class),
    WitherBoss("WitherBoss", 64, EntityType.WITHER, EntityWither.class, CustomWither.class),
    EnderDragon("EnderDragon", 63, EntityType.ENDER_DRAGON, EntityEnderDragon.class, CustomEnderDragon.class),
    ;
