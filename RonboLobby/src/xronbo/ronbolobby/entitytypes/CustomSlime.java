...
public class CustomSlime extends EntitySlime {
	...
	public CustomSlime(World world, boolean isPet) {
		super(world);
		this.isPet = true;
		try {
	...
	public void b_(EntityHuman entityhuman) {
		int i = getSize() < 2 ? 2 : getSize();
		if ((hasLineOfSight(entityhuman)) && (f(entityhuman) < 0.7D * i * 0.7D * i) && (entityhuman.damageEntity(DamageSource.mobAttack(this), bU()))) {
