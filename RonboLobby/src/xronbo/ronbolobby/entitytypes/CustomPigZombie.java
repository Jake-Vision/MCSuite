...
public class CustomPigZombie extends CustomZombie {
	...
	public CustomPigZombie(World world, boolean isPet) {
		super(world);
		this.isPet = true;
		try {
...
//	    	entity.pitch -= -20.0F;
	...
	private PathfinderGoalArrowAttack rangedLong = new PathfinderGoalArrowAttack(this, 1.5D, 20, 60, 30.0F);
	private PathfinderGoalArrowAttack rangedShort = new PathfinderGoalArrowAttack(this, 1.5D, 20, 60, 8.0F);
	private PathfinderGoalMeleeAttack melee = new PathfinderGoalMeleeAttack(this, EntityHuman.class, 1.7D, false);
